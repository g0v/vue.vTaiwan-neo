...
export const faqs: FAQ[] = [
  {
    ...
    answer_en:
      'vTaiwan is a platform that combines online and offline public policy discussions, aiming to promote rational dialogue between government, experts, and the public, and to jointly shape better policy solutions.',
    answer_ja:
      'vTaiwanは、オンラインとオフラインを組み合わせた公共政策討論プラットフォームです。市民参加とデジタルツールを通じて、政府、専門家、市民の理性的な対話を促進し、より良い政策を共に作り上げます。',
  },
  {
    id: '2',
    ...
    answer_en:
      'Any citizen interested in public policy can participate in the discussions on vTaiwan. Whether you are a general public, an expert, a business representative, or a government official, we welcome you to join our platform and share your views and suggestions.',
  ...
  },
  {
    ...
    details: ['議題收集：收集各方對特定政策議題的意見和建議', '意見徵集：透過線上平台廣泛徵集公眾意見', '審議討論：舉辦線上或實體會議，深入討論議題', '政策形成：整合各方意見，形成具體政策建議'],
    details_en: [
