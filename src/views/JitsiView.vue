    ...
    >
      ...
      <div v-if="!hasJoined" class="flex h-full items-center justify-center bg-gray-100">
        <div class="text-center">
          ...
          <input v-model="joinMeetingName" class="focus:ring-jade-green mb-4 w-full rounded-lg border border-gray-300 px-4 py-2 focus:ring-2 focus:outline-hidden" placeholder="請輸入您的名字" />
